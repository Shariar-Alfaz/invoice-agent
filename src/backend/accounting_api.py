"""Mock accounting API from docs/TAKE_HOME.md.
...
def _check_shape(payload):
    """Validate request types and formats."""
...
def _check_business_rules(payload):
    """Validate business rules and recalculate invoice totals from line items."""
...
def _create_invoice(payload):
    """Handle POST /invoices. Returns (status, response_body)."""
